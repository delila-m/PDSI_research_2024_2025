...
```
Looking at the original 'day number' label, it looks like the isn't observations over every single day, so I'll have to figure out how to translate the frequency of these labels to new labels.
```{r}
